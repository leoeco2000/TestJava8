...
/**
 * Created by Fant.J. 2018/2/7 17:01
 */
public class Reflection_DynamicProx {
  ...
  public static void main(String[] args) {
    ...
    CommonDao proxy = (CommonDao) Proxy.newProxyInstance(commonDao.getClass().getClassLoader(),
        commonDao.getClass().getInterfaces(), handler);
    proxy.insert(2, 3);
    proxy.insert(3, 3);
    proxy.delete(5, 2);
  }
  ...
  /**
   * 重写InvocationHandler 将代理上的所有方法调用转发 相当于 Method一章节中，我们讲到的反射实例化 aClass.getMethod("setName",
   * String.class); 然后调用ethod.invoke(people,"Fant.J");
   */
  static final class MyInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      System.out.println(
          "方法【" + method.getName() + "】执行完成,运算结果为:" + result + ", 用时" + (end - start) + "毫秒!");
      return result;
