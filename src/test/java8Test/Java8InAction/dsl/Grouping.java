...
import static test.java8Test.Java8InAction.chap6.Dish.menu;
import static test.java8Test.Java8InAction.dsl.Grouping.GroupingBuilder.groupOn;
import java.util.List;
import java.util.Map;
import java.util.function.Function;
import java.util.stream.Collector;
import test.java8Test.Java8InAction.chap6.Dish;
